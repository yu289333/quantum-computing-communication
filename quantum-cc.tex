...
Playing with water tricks is exactly the idea behind quantum computers. 
...
For engineers, only two concepts of quantum physics are needed: 1. all matters are waves even the seemingly size-less electrons and protons are; 2. all waves have their smallest drops, which cannot be divided futher. Physicists refer the two concepts the particle and wave duality of matters. In this book, we call the smallest drop of wave a quantum instead of a particle. To most people, particles have the image of point like or of negligible sizes. This image completely removes the wave nature from the picture and cause all the misunderstandings when learning quantum physics. We still call a quantum of light a photon and a quantum of electron waves an electron. We just avoid using the term particle.
