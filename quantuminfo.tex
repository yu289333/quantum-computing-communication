...
% Title
\textbf{\fontfamily{qcs}\fontsize{38}{54}\selectfont Quantum Information\\and Computing\\}
...
For a physicist, the problem could be simple: let's run water into the entrance. If we see water out of the exit, we know the maze problem has at least one solution or one good path from the entrance to the exit. How do we know whether there are more than one good paths or how many good paths there are?
